...
# --- Thresholds ---
USER_SIMILARITY_THRESHOLD = float(os.getenv("USER_SIMILARITY_THRESHOLD", 0.70))
EMPLOYEE_SIMILARITY_THRESHOLD = float(os.getenv("EMPLOYEE_SIMILARITY_THRESHOLD", 0.60))
